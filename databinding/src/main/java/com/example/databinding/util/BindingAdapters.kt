...
import com.example.databinding.Popularity
...
object BindingAdapters {
    ...
    private fun getAssociatedColor(popularity: Popularity, context: Context): Int {
        return when (popularity) {
            ...
            Popularity.POPULAR -> ContextCompat.getColor(context, R.color.colorAccent)
            Popularity.STAR -> ContextCompat.getColor(context, R.color.colorPrimary)
        }
    }
